...
| Document engine, halt gate, coherence | [ENGINE.md](ENGINE.md) |
...
| Next surface (plan only) | [plans/v0.6/README.md](plans/v0.6/README.md) |
...
5. API keys never enter a `Section`.
...
| Nexus one-file export + volumetric axes | planned ([v0.6](plans/v0.6/)) |

Generated 2026-09-01 from t484@main exploration + source headers.
